...
Depending on how you look at it, this release fixes an issue with some iframe-based text boxes not working, or it adds support for them. More rich text editors such as TinyMCE v4 should now be autofillable with Lightning Autofill.
