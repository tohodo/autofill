...
Just a quick heads-up on a minor hiccup we've run into. Due to the recent backend enhancements, the automated welcome emails got temporarily queued up and delayed. We're truly sorry for any confusion or frustration this caused, especially for our new members who joined recently and never received the activation instructions.

The good news: everything's sorted now, and those belated welcome emails should be landing in your inboxes today. If you're a recent joiner, keep an eye on your email (including spam/junk folders just in case). If you still don't see it by the end of today, feel free to [contact support](mailto:support@tohodo.com). Thanks for your patience and understanding! 🙏
