...
After six months of review hell and countless code chagnes to comply with stricter Google policies, Lightning Autofill v14 has FINALLY been approved for release to the Chrome Web Store! 🥳 Now we can proceed with long-planned features like the macro recorder and other goodies down the road.
...
3. If Chrome has pending updates, update and restart the browser. You can see if Chrome has pending udpates by clicking menu / Help / About Google Chrome.
4. If Windows has pending updates, update Windows and restart your PC. You can see if Windows has pending udpates by going to Settings / Windows Update.
