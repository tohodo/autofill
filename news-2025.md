...
This is a hotfix to address these two issues:

1. Incrementing and decrementing variables (e.g., `{1++}`) were iterating twice. This has been fixed.
2. Some sites such as [web.whatsapp.com](https://web.whatsapp.com/) were getting logged out. This bug has been squashed.
