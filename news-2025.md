...
Thanks to the help of some dedicated users, more bugs were slayed in this release, in addition to more internal improvements that are not visible. Users on the free tier may be delighted to know that a hard-to-troubleshoot issue where the quota wasn't being reset daily has been fixed.
