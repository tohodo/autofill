...
In Autofill v11 (MV2) we used to be able to use a special function called `Autofill()` in JavaScript rules. For example, to execute a profile with ID "c1" after a 4-second delay, you'd enter this as your JavaScript rule:
