...
- **Added "Profile expiration" option (experimental)** - This was a special request by at least two users. Similar to cookies, you can set your profiles to expire and auto-delete (along with their rules) by specifying `Expires: YYYY-DD-MM` anywhere in the profile name. For example, if you have a profile named "My Profile (Expires: 2024-08-01)", then it will be deleted at midnight on August 1st, 2024. This option is under the **Settings** / **Experimental** section.
