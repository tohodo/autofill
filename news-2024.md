...
**UPDATE:** After v12.0.3 was released, I was still getting reports of the Options page being blank in Edge even though it was working fine for me. After digging some more, I identified the real root cause: sadly, Chrome and Edge require you to enable Developer mode in order to use the new MV3 UserScript API that is used to implement the JavaScript rules:
