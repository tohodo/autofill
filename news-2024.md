...
There is also a known issue with some variables breaking -- we are working on a fix ASAP and hopefully will have a hotfix out by end of today. Sorry for the inconvenience.
