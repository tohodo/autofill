...
- `AUTOFILL` [🎞️](https://youtu.be/YO2sIxa4Pes) - execute a profile (this replaces the special `Autofill()` function from v11)
- `CLICK` [🎞️](https://youtu.be/arbFQRwiuvM) - click an element
- `DISPATCH` [🎞️](https://youtu.be/A7j9zHM1tFI) - send one or more events to an element
- `OPEN` [🎞️](https://youtu.be/4zfCzprL-XY) - open a URL in the current tab or a new tab
- `RELOAD` [🎞️](https://youtu.be/NUHq7OPJDl8) - reload the page until an element is found
- `SCRAPE` [🎞️](https://youtu.be/zRln5RNf9AE) - extract text from an element and store it in a temporary variable that can be used in subsequent rules
- `STYLE` [🎞️](https://youtu.be/eUCGIJPzkLM) - apply custom CSS to an element
- `WAIT` [🎞️](https://youtu.be/GOTfMHTzOPc) - wait for *N* number of seconds, or for an element to be loaded on the page
...
This release coincides with the debut of our overhauled modern [documentation site](https://docs.lightningautofill.com/). When you click on the Help button in Lightning Autofill Options, instead of opening a web page in a new tab, it will show the context-sensitive help in a sidepanel for easier referencing. The new help system also has a built-in search box to help you find things faster.
