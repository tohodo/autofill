...
A user reported v12.5 broke something that was working in v12.3, so to be on the safe side we rolled back to v12.3 while we take a look at this regression issue today. Version 12.5.1 is actually version 12.3.0. Stay tuned...
