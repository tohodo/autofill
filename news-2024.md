...
With this giant bugfix release, all known autofilling issues have been squashed. It took awhile (apologies and thanks for the patience), but Lightning Autofill v12.3.0 _should_ be as stable as the last MV2 version (v11.9.0). If you still encounter issues, it's very likely this issue also existed in v11.9.0 (you can verify by testing on the Firefox version, which is still on MV2).
